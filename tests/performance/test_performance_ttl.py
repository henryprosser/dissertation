...
class SolidPodUpdaterTTL:
    ...
    def start(self, performance_log):
        ...
        while True:
            ...
            while True:
                try:
                    ...
                    self.hash_file("./tests/performance/performance_test_file.ttl")
                    # Deletes the file locally
                    os.remove(local_file)
                    # Deletes the file in the Solid Pod
                    self.api.delete(file_url)
                    break
                except Exception:
                    print(
            ...
            performance_log.append(end - start)
            print(f"Run {len(performance_log)} completed")
    ...
    def generate_turtle_rdf(datetime, list_of_headers, list_of_data):
        ...
        # Empty URIRef seems to get interpreted as itself in Solid.
        aqm = URIRef("")
...
def test_performance():
    ...
    # Run the updater performance tests
    performance_log = updater.start(performance_log)
    print(performance_log)
    print(f"Average time for one cycle: {np.mean(performance_log)}")
